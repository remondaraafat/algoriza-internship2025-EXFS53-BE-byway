    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditCardPaymentMethods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CreditCardPaymentMethods_PaymentMethods_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayPalPaymentMethods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayPalPaymentMethods_PaymentMethods_Id",
                        column: x => x.Id,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentCourses_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentCourses_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentCourses_CourseId",
                table: "PaymentCourses",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentCourses_PaymentId",
                table: "PaymentCourses",
                column: "PaymentId");
