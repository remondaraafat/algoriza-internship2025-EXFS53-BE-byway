...
{
    public class MicrosoftRegisterCommand : IRequest<GeneralResponse<List<string>>>
    {
        public MicrosoftRegisterDTO DTO { get; set; }
    }

    public class MicrosoftRegisterCommandHandler : IRequestHandler<MicrosoftRegisterCommand, GeneralResponse<List<string>>>
    {
        private readonly UserManager<ApplicationUser> userManager;

        public MicrosoftRegisterCommandHandler(UserManager<ApplicationUser> userManager)
        {
            this.userManager = userManager;
        }

        public async Task<GeneralResponse<List<string>>> Handle(MicrosoftRegisterCommand request, CancellationToken cancellationToken)
        {
            ...
            return GeneralResponse<List<string>>.SuccessResponse("Microsoft user registered successfully");
        }
    }
